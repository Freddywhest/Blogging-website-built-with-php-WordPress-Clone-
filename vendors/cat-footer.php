									...
									<div class="post-block-style post-float clearfix">
										<div class="post-thumb">
											<a href="../../p-detail/<? echo $post_id; ?>/<? echo $post_url; ?>">
												<img class="img-fluid" width="100%" src="../.././uploads/<? echo $post_image; ?>" alt="" />
											</a>
										</div><!-- Post thumb end -->
				...
				<div class="row">
					<div class="col-sm-12 col-md-6">
						<div class="copyright-info">
							<span>Copyright © <?php echo date("Y");?> <? echo $s_name; ?> All Rights Reserved. Designed By <a style="color:black" href="https://alfrednti.com"><b>Alfred 😘</b></a></span>
						</div>
					</div>
