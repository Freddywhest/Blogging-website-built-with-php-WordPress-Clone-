				...
				<div class="col-lg-4 col-md-12">
					...
					<? include "vendors/social.php"; ?>
						<div class="widget color-default">
							<h3 class="block-title"><span>Popular <? echo $p_name != "Others"?"{$p_name}":"Posts"; ?></span></h3>
									...
									<li class="clearfix">
										<div class="post-block-style post-float clearfix">
											...
											<div class="post-content">
												...
												<? }else{ ?>
												<div class="post-meta">
									 				<span class="post-date"><? echo $post_de; ?></span>
									 			</div>
												<? } ?>
							...
							<div id="post-slide" class="owl-carousel owl-theme post-slide">
								...
								<?
									...
									<div class="post-overaly-style text-center clearfix">
									   <div class="post-thumb">
									      <a href="../../h-details.php/<? echo $hot_post_id; ?>/<? echo $hot_post_url; ?>">
									         <img class="img-fluid" src="../../uploads/<? echo $hot_post_image; ?>" alt="<? echo $hot_post_title; ?>" />
									      </a>
									   </div><!-- Post thumb end -->

									   <div class="post-content">
									      <a class="post-cat" href="../../h-details.php/<? echo $hot_post_id; ?>/<? echo $hot_post_url; ?>"><? echo $category_name; ?></a>
									      <h2 class="post-title">
									         <a href="../../h-details.php/<? echo $hot_post_id; ?>/<? echo $hot_post_url; ?>"><? echo $post_title; ?></a>
									      </h2>
									      <? if($u_reg == 'Yes'){ ?>
									 			<div class="post-meta">
									 				<span class="post-date"><? echo $post_date; ?></span>
		...
		<div class="container">
			<div class="row">
				...
				while($post = $stmt->fetch(PDO::FETCH_ASSOC)){
					$post_id = $post['post_id'];
					$post_title = $post['post_title'];
					$post_detail = substr($post['post_detail'], 0, 255);
					$post_url = $post['post_url'];
					$post_category_id = $post['post_category_id'];
					// getting category name
					$sql1 = "SELECT * FROM categories WHERE category_id = :id";
